...
import mockGetNumberFilterData from '../../__mock__/data/mockGetNumberFilterData'
...
describe('Running all functions with mock data', () => {
  const mockData = mockGetNumberFilterData()
  const mock1 = [mockData[0].countryMin, mockData[0].countryMax]
  const mock2 = [mockData[1].countryMin, mockData[1].countryMax]
  const mock3 = [mockData[2].countryMin, mockData[2].countryMax]
